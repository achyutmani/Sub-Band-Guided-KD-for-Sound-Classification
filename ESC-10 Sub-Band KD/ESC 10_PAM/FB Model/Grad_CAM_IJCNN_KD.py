...
MODEL_SAVE_PATH = os.path.join("/home/mani/Desktop/AK/Explainable ASC/ESC-10", 'PAM_ESC10_CNN.pt') # Define Path to save the model 
...
def feature_Map(model,Input_Data):
    ...
    return F_Map
key='SEA_Waves_2-125966-A.ogg'    
#key ='BABY_CRY_1-22694-B.ogg'
...
plt.savefig('/home/mani/Desktop/AK/Explainable ASC/ESC-10/GCAM/9/SEA_Waves_2-125966-A', bbox_inches='tight') # bbox_inches removes extra white spaces
plt.show()
