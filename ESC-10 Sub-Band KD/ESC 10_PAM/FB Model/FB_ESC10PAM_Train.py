...
EPOCHS =200   # Define maximum Number of Epochs
FC_Size=512
SFC_Size=512
Temp=3
alpha=0.7
...
np.save('Fb_PAM_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
