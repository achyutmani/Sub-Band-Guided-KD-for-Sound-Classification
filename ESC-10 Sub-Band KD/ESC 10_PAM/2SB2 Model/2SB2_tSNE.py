...
from Pathname import SB22_PAM_Path
SEED = 1234
random.seed(SEED)
np.random.seed(SEED)
...
plt.savefig('tSNE_SB22_PAM_ESC10.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces
