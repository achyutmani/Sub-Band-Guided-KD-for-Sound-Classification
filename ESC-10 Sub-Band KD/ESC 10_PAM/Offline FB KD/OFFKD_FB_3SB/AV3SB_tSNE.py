...
from Attention import PAM_Module # import channel attention module
...
from Pathname import FB_PAM_Path
from Pathname import FB_PAM_Path,SB21_PAM_Path,SB22_PAM_Path,S2_PAM_AV_Path
SEED = 1234
random.seed(SEED)
np.random.seed(SEED)
...
plt.legend()
#plt.legend(bbox_to_anchor=(1.20, 1.0),prop={'size': 20})
plt.xticks(size=30)
plt.yticks(size=30)
...
plt.savefig('tSNE_AV3SB_PAM_ESC10.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces
