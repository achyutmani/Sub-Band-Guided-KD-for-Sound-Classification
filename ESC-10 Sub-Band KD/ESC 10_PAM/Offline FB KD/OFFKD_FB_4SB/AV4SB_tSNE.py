...
from Pathname import FB_PAM_Path,SB21_PAM_Path,SB22_PAM_Path,S3_PAM_AV_Path
SEED = 1234
random.seed(SEED)
np.random.seed(SEED)
...
plt.savefig('tSNE_AV4SB_PAM_ESC10.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces
