...
alpha=0.3
N_models=5
from Pathname import FB_PAM_Path, SB41_PAM_Path,SB42_PAM_Path,SB43_PAM_Path,SB44_PAM_Path,S3_PAM_AV_Path
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = S3_PAM_AV_Path
...
np.save(' S3_PAM_AV_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
