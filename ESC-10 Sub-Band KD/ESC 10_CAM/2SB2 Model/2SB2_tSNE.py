...
from Pathname import SB22_CAM_Path
SEED = 1234
random.seed(SEED)
np.random.seed(SEED)
...
plt.savefig('tSNE_SB22_CAM_ESC10.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces
