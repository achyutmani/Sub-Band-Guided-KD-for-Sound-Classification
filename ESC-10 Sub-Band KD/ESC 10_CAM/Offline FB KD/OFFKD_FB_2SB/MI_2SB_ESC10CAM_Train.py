...
import warnings
from Pathname import FB_CAM_Path,SB21_CAM_Path,SB22_CAM_Path,S1_CAM_MI_Path
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = S1_CAM_MI_Path
...
np.save('S1_CAM_MI_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
