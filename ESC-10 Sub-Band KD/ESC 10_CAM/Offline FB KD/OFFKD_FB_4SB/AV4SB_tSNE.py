...
from Pathname import FB_CAM_Path,SB21_CAM_Path,SB22_CAM_Path,S3_CAM_AV_Path
SEED = 1234
random.seed(SEED)
np.random.seed(SEED)
...
plt.savefig('tSNE_AV4SB_CAM_ESC10.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces
