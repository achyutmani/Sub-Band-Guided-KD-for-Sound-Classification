...
alpha=0.3
N_models=5
from Pathname import FB_CAM_Path, SB41_CAM_Path,SB42_CAM_Path,SB43_CAM_Path,SB44_CAM_Path,S3_CAM_MI_Path
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = S3_CAM_MI_Path
...
np.save('S3_CAM_MI_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
