...
from Pathname import FB_SA_Path, SB31_SA_Path,SB32_SA_Path,SB33_SA_Path,S2_SA_WE_Path
import warnings
...
for epoch in range(EPOCHS):
    ...
    early_stopping(valid_loss,Student_Model,S2_SA_WE_Path) # call Early Stopping to Prevent Overfitting 
    if early_stopping.early_stop:
        print("Early stopping")
        break
    Student_Model.load_state_dict(torch.load(MODEL_SAVE_PATH))
np.save('S2_SA_WE_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
