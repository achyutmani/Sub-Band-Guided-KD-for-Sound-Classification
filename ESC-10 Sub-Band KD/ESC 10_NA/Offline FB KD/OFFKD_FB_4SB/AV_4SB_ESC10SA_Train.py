...
alpha=0.3
N_models=5
from Pathname import FB_SA_Path, SB41_SA_Path,SB42_SA_Path,SB43_SA_Path,SB44_SA_Path,S3_SA_AV_Path
...
np.save(' S3_SA_AV_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
