...
import warnings
from Pathname import FB_SA_Path,SB21_SA_Path,SB22_SA_Path,S1_SA_AV_Path
...
np.save('S1_SA_AV_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
