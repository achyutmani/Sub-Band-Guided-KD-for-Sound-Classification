...
from Pathname import FB_CAM_Path, SB31_CAM_Path,SB32_CAM_Path,SB33_CAM_Path,S2_CAM_MI_Path
import warnings
...
for epoch in range(EPOCHS):
    ...
    early_stopping(valid_loss,Student_Model,S2_CAM_MI_Path) # call Early Stopping to Prevent Overfitting 
    if early_stopping.early_stop:
        print("Early stopping")
        break
    Student_Model.load_state_dict(torch.load(MODEL_SAVE_PATH))
np.save('S2_CAM_MI_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
