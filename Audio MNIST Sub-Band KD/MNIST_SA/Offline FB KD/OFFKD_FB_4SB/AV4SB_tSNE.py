...
from Pathname import FB_SA_Path,SB21_SA_Path,SB22_SA_Path,S3_SA_AV_Path
SEED = 1234
random.seed(SEED)
np.random.seed(SEED)
...
plt.savefig('tSNE_AV4SB_MNIST_ESC10.pdf', bbox_inches='tight') # bbox_inches removes extra white spaces
