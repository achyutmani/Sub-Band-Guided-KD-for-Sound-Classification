...
import warnings
from Pathname import FB_PAM_Path,SB21_PAM_Path,SB22_PAM_Path,S1_PAM_AV_Path
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = S1_PAM_AV_Path
...
np.save('S1_PAM_AV_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
