...
alpha=0.3
N_models=5
from Pathname import FB_PAM_Path, SB41_PAM_Path,SB42_PAM_Path,SB43_PAM_Path,SB44_PAM_Path,S3_PAM_MI_Path
...
def MINEN_Loss(Predicted_FB_Label,Predicted_SB1_Label, Predicted_SB2_Label,Predicted_SB3_Label,Predicted_SB4_Label,Predicted_Student_Label,T,N_models,y,device):
        ...
        L_Array=torch.tensor([FB_Loss,SB1_Loss,SB2_Loss,SB3_Loss,SB4_Loss])
        ...
        if Min_Loss_Index==4:
            Student_Loss=F.kl_div(Student_Prob,SB4_Prob)    
        return Student_Loss
...
def train(FB_Model, SB1_Model, SB2_Model,SB3_Model,SB4_Model,Student_Model,device,iterator, optimizer, criterion,alpha,Temp): # Define Training Function 
    ...
    for (a,b,c,d,e,y) in iterator:
        ...
        EN_AVG_Loss=MINEN_Loss(Predicted_FB_Label,Predicted_SB1_Label, Predicted_SB2_Label,Predicted_SB3_Label,Predicted_SB4_Label,Predicted_Train_Label,Temp,N_models,y,device)
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = S3_PAM_MI_Path
...
np.save('S3_PAM_MI_ESC10_Model_Parameters',Temp) # Save Temp Array as numpy array 
